  ...
  return (
    <div className="overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center pt-20 bg-slate-50">
        ...
        <div className="section-padding relative z-20 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <motion.div
          ...
          >
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/contact" className="btn-primary flex items-center gap-2 px-8 py-4">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -inset-4 bg-medical-500/10 rounded-2xl blur-3xl transform -rotate-6" />
            <div className="relative bg-white p-4 rounded-[40px] shadow-2xl overflow-hidden border-8 border-white group">
              <img 
                src={heroImage} 
                alt="Dr. Rohit Mudadla" 
                className="w-full h-auto rounded-[32px] group-hover:scale-105 transition-transform duration-700"
              />
              <div className="absolute bottom-10 left-10 right-10 p-6 bg-white/90 backdrop-blur-md rounded-2xl shadow-xl flex items-center gap-4 border border-white/50">
                <div className="p-3 bg-medical-600 rounded-xl text-white">
                  <Shield size={24} />
                </div>
                <div>
                  <h3 className="font-bold text-slate-900">Dr. Rohit Mudadla</h3>
                  <p className="text-xs text-medical-600 font-bold uppercase tracking-wide">M.S., M.Ch. (Surgical Gastroenterology)</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      {/* Stats Section */}
      <section className="py-20 bg-medical-900 text-white border-y border-medical-800">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 lg:grid-cols-4 gap-12 text-center">
          {[
            ...
            >
              ...
              <h3 className="text-4xl font-bold mb-2">{stat.value || '100%'}</h3>
              <p className="text-medical-200 text-sm font-medium uppercase tracking-widest">{stat.label}</p>
            </motion.div>
          ))}
        </div>
      </section>
      ...
      <section className="bg-medical-600 py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
             <div>
                <h2 className="text-white text-4xl lg:text-5xl font-bold leading-tight mb-6">Expert Surgical <br />Gastroenterology Care</h2>
                <p className="text-medical-50 text-lg opacity-90 leading-relaxed max-w-lg">
             ...
             <div className="grid grid-cols-2 gap-12">
                <div>
                   <div className="text-6xl lg:text-7xl font-bold text-white mb-2">150+</div>
                   <div className="text-medical-100 font-medium uppercase tracking-widest text-sm">Complex Surgeries</div>
                   <div className="text-medical-200/60 text-xs mt-1">12 Years of Excellence</div>
                </div>
                <div>
                   <div className="text-6xl lg:text-7xl font-bold text-white mb-2">1500</div>
                   <div className="text-medical-100 font-medium uppercase tracking-widest text-sm">Trusted Patients</div>
      ...
      <section className="section-padding bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="heading-lg mb-8">Ready to restore your <span className="text-medical-600">Digestive Health?</span></h2>
          <p className="text-slate-600 text-lg mb-10">Schedule a detailed consultation with Dr. Rohit Mudadla today at OMNI Hospitals, Ramnagar, Visakhapatnam.</p>
          <Link to="/contact" className="btn-primary px-12 py-5 text-lg inline-flex items-center gap-3">
