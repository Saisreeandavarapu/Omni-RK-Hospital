    ...
    <section className="section-padding overflow-hidden">
      <div className="text-center mb-12 sm:mb-20">
        ...
        >
          ...
          <h2 className="heading-xl mb-3 sm:mb-4">World-Class <span className="text-medical-600">Surgical Services</span></h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 sm:gap-8 mb-12 sm:mb-20">
        {services.map((service, i) => (
          <motion.div
            ...
            className="group p-6 sm:p-8 bg-white rounded-[28px] sm:rounded-[40px] shadow-sm hover:shadow-2xl border border-slate-100 transition-all duration-500 flex flex-col h-full"
          >
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-medical-50 text-medical-600 rounded-xl sm:rounded-2xl flex items-center justify-center shrink-0 mb-5 sm:mb-8 group-hover:bg-medical-600 group-hover:text-white transition-colors duration-500">
              <service.icon size={24} />
            </div>
            <h3 className="text-lg sm:text-2xl font-bold mb-3 sm:mb-4 text-slate-900 leading-tight">{service.title}</h3>
            <p className="text-slate-600 mb-5 sm:mb-8 leading-relaxed flex-grow text-sm sm:text-base">{service.desc}</p>
      ...
      {/* Infrastructure CTA */}
      <div className="relative rounded-[32px] sm:rounded-[56px] overflow-hidden bg-medical-900 text-white p-8 sm:p-12 lg:p-24 group">
        ...
        <div className="relative z-10 max-w-2xl">
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold mb-5 sm:mb-8 leading-tight">State-of-the-Art <br />Surgical Infrastructure</h2>
          <p className="text-base sm:text-lg text-medical-100 mb-6 sm:mb-10 opacity-90 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4 sm:gap-6">
             <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-md">
                   <Activity size={20} className="text-medical-400" />
                </div>
                <div>
                   <p className="text-xs sm:text-sm font-bold uppercase tracking-widest">Precision</p>
                   <p className="text-xs opacity-60">High-Def Imaging</p>
                </div>
             </div>
             <div className="flex items-center gap-3">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/10 rounded-2xl flex items-center justify-center backdrop-blur-md">
                   <Shield size={20} className="text-medical-400" />
                </div>
                <div>
                   <p className="text-xs sm:text-sm font-bold uppercase tracking-widest">Safety</p>
